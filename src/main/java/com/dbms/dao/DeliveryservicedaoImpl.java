...
public class DeliveryservicedaoImpl implements Deliveryservicedao{
	...
	public Deliveryservice getDservice(Long sid) {
		...
		public Deliveryservice extractData(ResultSet rs) throws SQLException,DataAccessException{
			if(rs.next()) {
				...
				deliveryservice.setPhone_no(rs.getLong("phone_no"));
	...
	public void saveOrUpdateDservice(Deliveryservice deliveryservice) {
		String sql="INSERT INTO Deliveryservice(name,phone_no) VALUES(?,?)";
		jdbcTemplate.update(sql,new Object[] {deliveryservice.getName(),deliveryservice.getPhone_no()});
	...
	public void dsUpdate(Deliveryservice deliveryservice) {
		String sql="update Deliveryservice set name=?,phone_no=? where sid=?";
		jdbcTemplate.update(sql, new Object[] {deliveryservice.getName(),deliveryservice.getPhone_no(),deliveryservice.getSid()});
