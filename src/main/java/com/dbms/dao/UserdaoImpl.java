...
public class UserdaoImpl implements Userdao{
	...
	public void saveOrUpdateCustomer(User user) {
		...
		jdbcTemplate.update(sql,new Object[] {user.getName(),user.getAddress(),user.getCity(),user.getState(),user.getPincode(),user.getPhone_no(),user.getEmail(),user.getUsername()});
...
//				user.setUsername(rs.getString("username"));
				...
				user.setPhone_no(rs.getLong("phone_no"));
	...
	public List<User> showUser(String username){
		...
		List <User> alluser=jdbcTemplate.query(sql,new RowMapper<User>() {
			...
			public User mapRow(ResultSet rs, int rowNum) throws SQLException{
				...
				usr.setPincode(rs.getLong("pincode"));
				usr.setPhone_no(rs.getLong("phone_no"));
