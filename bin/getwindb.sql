...
INSERT INTO `Vendor` VALUES (8,'Havells','Industrial Area','havells.com','Chandigarh','',133004,'pr@havells.com',7894561230),(9,'Lloyd','Industrial Area','lloyd.in','Ambala','Haryana',133001,'pr@lloyd.in',7894561230);
...
CREATE TABLE `PayLog` (
  ...
  CONSTRAINT `PayLog_ibfk_2` FOREIGN KEY (`man_id`) REFERENCES `Vendor` (`vendor_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `PayLog` VALUES (7,NULL,9,'2018-09-18','Vendor',10000.00),(8,11,NULL,'2018-10-01','Employee',5000.00);
...
CREATE TABLE `Product` (
  ...
  KEY `vid` (`vid`),
  CONSTRAINT `Product_ibfk_1` FOREIGN KEY (`vid`) REFERENCES `Vendor` (`vendor_id`) ON DELETE SET NULL ON UPDATE CASCADE,
